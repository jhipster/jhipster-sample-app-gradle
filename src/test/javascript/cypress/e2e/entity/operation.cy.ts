...
describe('Operation e2e test', () => {
  ...
  const operationSample = { date: '2015-08-05T04:37:38.865Z', amount: 60242 };
  ...
  describe('new Operation page', () => {
    ...
    it('should create an instance of Operation', () => {
      cy.get(`[data-cy="date"]`).type('2015-08-05T06:06');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2015-08-05T06:06');

      cy.get(`[data-cy="description"]`).type('judgementally Bicycle');
      cy.get(`[data-cy="description"]`).should('have.value', 'judgementally Bicycle');

      cy.get(`[data-cy="amount"]`).type('16046');
      cy.get(`[data-cy="amount"]`).should('have.value', '16046');
