...
describe('Label e2e test', () => {
  ...
  let username: string;
  let password: string;
  const labelSample = { label: 'mismatch above override' };
  ...
  describe('Label page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Label').should('not.contain', 'jhipsterGradleSampleApplicationApp.label.home.title');
    });
  ...
  describe('new Label page', () => {
    ...
    it('should create an instance of Label', () => {
      cy.get(`[data-cy="label"]`).type('um sticky');
      cy.get(`[data-cy="label"]`).should('have.value', 'um sticky');
