...
describe('Label e2e test', () => {
  ...
  const labelSample = { label: 'knowledgeably uh-huh promptly' };
  ...
  describe('new Label page', () => {
    ...
    it('should create an instance of Label', () => {
      cy.get(`[data-cy="label"]`).type('as usually pointed');
      cy.get(`[data-cy="label"]`).should('have.value', 'as usually pointed');
