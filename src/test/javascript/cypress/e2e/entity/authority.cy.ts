...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'bca1b184-4d24-4544-86bf-ccd73709cbab' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('ba90ad50-93c4-46ec-83f4-3d70b0a280c0');
      cy.get(`[data-cy="name"]`).should('have.value', 'ba90ad50-93c4-46ec-83f4-3d70b0a280c0');
