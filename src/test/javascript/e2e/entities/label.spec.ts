...
describe('Label e2e test', () => {
    ...
    it('should load Labels', () => {
        ...
        expect(labelComponentsPage.getTitle()).toMatch(/jhipsterGradleSampleApplicationApp.label.home.title/);
    ...
    it('should load create Label dialog', () => {
        ...
        expect(labelDialogPage.getModalTitle()).toMatch(/jhipsterGradleSampleApplicationApp.label.home.createOrEditLabel/);
