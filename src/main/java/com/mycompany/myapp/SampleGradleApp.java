...
public class SampleGradleApp {

    private static final Logger log = LoggerFactory.getLogger(SampleGradleApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes sampleGradle.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SampleGradleApp.class);
