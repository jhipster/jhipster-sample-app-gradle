...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "sampleGradle@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "sampleGradle API";

        private String description = "sampleGradle API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "sampleGradle";
